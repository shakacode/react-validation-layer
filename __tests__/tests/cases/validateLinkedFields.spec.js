...
describe('case.validateLinkedFields', () => {
  it('validates linked field of JS Object', () => {
    ...
    expect(
      Form.find('.password-confirmation-wrapper').hasClass('failure'),
    ).toBe(false);
    expect(
      Form.find('.password-confirmation-wrapper').hasClass('success'),
    ).toBe(false);
    ...
    expect(Form.find('.password-confirmation-message').text()).toBe(
  ...
  it('validates linked field of Immutable Record', () => {
    ...
    // User types invalid `passwordConfirmation`
    Form.setProps({
      data: new Data({ password: '123', passwordConfirmation: '12' }),
    });
    Form.find('.password-confirmation-input').simulate('change');
    ...
    // User types valid `passwordConfirmation`
    Form.setProps({
      data: new Data({ password: '123', passwordConfirmation: '123' }),
    });
    Form.find('.password-confirmation-input').simulate('change');
    ...
    // User changes `password`
    Form.setProps({
      data: new Data({ password: '1234', passwordConfirmation: '123' }),
    });
    Form.find('.password-input').simulate('change');
